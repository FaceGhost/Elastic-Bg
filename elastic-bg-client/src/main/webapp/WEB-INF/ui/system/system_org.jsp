...
<shiro:hasPermission name="system:org:view">
    <script src="${base}static/uijs/system/system_org.js?v=<%=JsCssVersionConst.getJsVersion()%>"></script>
    <script src="${base}static/uijs/system/system_org_oper.js?v=<%=JsCssVersionConst.getJsVersion()%>"></script>
</shiro:hasPermission>
