...
<shiro:hasPermission name="system:user:view">
    <script src="${basepath}statics/uijs/system/system_user.js?t=<%=new Date().getTime()%>"></script>
    <script src="${basepath}statics/uijs/system/system_user_oper.js?t=<%=new Date().getTime()%>"></script>
</shiro:hasPermission>
