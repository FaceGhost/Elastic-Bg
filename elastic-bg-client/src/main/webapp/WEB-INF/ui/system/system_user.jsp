...
<shiro:hasPermission name="system:user:view">
    <script src="${basepath}static/uijs/system/system_user.js?v=<%=JsCssVersionConst.getJsVersion()%>"></script>
    <script src="${basepath}static/uijs/system/system_user_oper.js?v=<%=JsCssVersionConst.getJsVersion()%>"></script>
</shiro:hasPermission>
