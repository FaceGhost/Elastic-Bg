	...
	layout_tabs = Ext.create('Ext.tab.Panel', {
		...
		plugins: [
			Ext.create('Ext.ux.TabCloseMenu', {
				closeTabIcon: 'ext-6.0.0/ext/icon/page.png',
				closeOtherslayout_tabsIcon: 'ext-6.0.0/ext/icon/page2.png',
				closeAlllayout_tabsIcon: 'ext-6.0.0/ext/icon/page3.png',
				extraItemsTail: [
					{
						text: '刷新',
						handler: function(){
						...
						icon:'ext-6.0.0/ext/icon/refresh2.png',
						mc_:169
					} 
				]
			}),
